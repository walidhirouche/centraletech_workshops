...
url_api = 'https://uselessfacts.jsph.pl//api/v2/facts/random'
reponse = ..
if .. == 200:
    print(reponse.text)
    ..
    ...
    print("Une erreur est survenue:", reponse.status_code, reponse.text)


# Bonus : traduire le contenu de la réponse (l'information) en français en utilisant une api de traduction anglais français